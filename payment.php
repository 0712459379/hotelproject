<?php
// run in cmd ngrok http 80 to find live server
require  '../vendor/autoload.php';//possible error
...
function lipaNaMpesaPassword()
{
   ...
   {
       $consumer_key="MLgoQ3U7nbJ7a1F3cU1HmIajhYLGmLeV";
       $consumer_secret="gS921nWpc2e60z9r";
   ...
   function stkPush($amount)
   {
     ...
     // header("location: http://87904cd46158.ngrok.io/hotel/try.php");
   }
